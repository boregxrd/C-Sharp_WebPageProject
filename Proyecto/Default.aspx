    ...
    <form id="form1" runat="server">
        ...
        <div class="hero-section">
            ...
            <div class="content-overlay">
                <p class="welcome-message">
                    Welcome to Techville University, where innovation meets education. Join us on a journey of discovery and excellence in technology.
                </p>
            </div>
        </div>
        ...
        <div class="main-content">
            <div class="featured-programs">
                ...
                <p>Dive into the future with our programs in Computer Science, Robotics, Artificial Intelligence, and more.</p>
            </div>

            <div class="admissions-info">
                <h2>Start Your Journey</h2>
                <p>Learn about our admissions process, application requirements, and key dates. Your future at Techville begins here.</p>
            </div>

            <div class="latest-news">
                <h2>Stay Informed</h2>
                <p>Read about the latest achievements, breakthroughs, and announcements from Techville University.</p>
            </div>

            <div class="upcoming-events">
                <h2>Connect with Us</h2>
                <p>Check out our calendar for upcoming events, workshops, and seminars. Don't miss the opportunity to be part of the Techville experience.</p>
            </div>
        </div>
        ...
        <aside class="sidebar">
            <div class="quick-links">
                <h2>Quick Links</h2>
                <p>Academic Calendar, Campus Map, Student Resources.</p>
            </div>

            <div class="social-media-feeds">
                <h2>Join the Conversation</h2>
                <p>Follow us on social media for real-time updates, behind-the-scenes, and community stories.</p>
            </div>
        </aside>
